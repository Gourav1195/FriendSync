...
import { useCreateUserAccount, useSignInAccount } from "@/lib/react-query/querriesAndMutations"
...
const SignupForm = () => {
  ...
  async function onSubmit(values: z.infer<typeof SignupValidation>) {
    ...
    if(!session){
      return toast({ title: 'SIgn in failed. Pls try again'})
    }

  }
//sm:w-420: small devices width is 420; h3-bold: small size; pt-5: padding top of 5; 
  return (
    <>
    <Form {...form}>
